...
func askForConfirmation() bool {
	...
	allOkayResponses := []string{"a", "A", "all", "All", "ALL"}
	okayResponses := []string{"y", "Y", "yes", "Yes", "YES"}
	nokayResponses := []string{"n", "N", "no", "No", "NO"}
	if containsString(allOkayResponses, response) {
		allConfirm = true
		return allConfirm
	} else if containsString(okayResponses, response) {
		return true
